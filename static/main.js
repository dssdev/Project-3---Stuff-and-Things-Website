...
var getStuff = function(){
    $.getJSON($SCRIPT_ROOT + '_get_stuff', function(data){
        //empty the list so we don't have duplicates
        stuffList = [];
          $('#stuffDiv').empty();
          $("#stuffDiv").accordion({
               collapsible: true
...
var getThing = function(id){
    $.getJSON( "/getthing", { 'id': id}, function(data){
        ...
        $('#thingsDiv').html("<h2>" + data.Thing[0].name + "<i>(qty: " + data.Thing[0].quantity +")</i>" + "</h2>"
                            + "<div class='thing-link'><a href='#' id='addLink'>Add New | </a><a href='#' id='editLink'>Edit | </a><a href='#' id='deleteLink'>Delete </a></div>"
...
var deleteThing = function(id){
    ...
    var posting = $.post('/deletething', {'id': id}, function(data){
        getStuff();
